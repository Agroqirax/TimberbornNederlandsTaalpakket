...
![Een bever in een tulpenveld](Root/thumbnail.jpg)
...
Ook zijn een groot aantal populaire mods vertaald.

## De mod installeren

- [Steam workshop](https://steamcommunity.com/sharedfiles/filedetails/?id=3345327949): Click op abonneren
- [Mod.io](https://mod.io/g/timberborn/m/nederlands-taalpakket): Download het zip bestand en pak uit naar `~/Documents/Timberborn/Mods/NederlandsTaalpakket`.
- [Github](https://github.com/agroqirax/TimberbornNederlandsTaalpakket/releases/latest): Download het zip bestand en pak uit naar `~/Documents/Timberborn/Mods/NederlandsTaalpakket`.
...
Je mag gerust hier de vertalingen van je mods kopiëren en ze in je eigen mod opnemen als je dat wilt.
...
- Discord: `@Agroqirax` in de [timberborn discord server](https://discord.gg/timberborn).
...
If you need help translating a new or untranslated mod, just let me know on the [discord](https://discord.gg/timberborn) (`@Agroqirax`), I'm there to help!
